...
async function initDb() {
  ...
  if (parseInt(result.rows[0].c) === 0) {
    await pool.query('INSERT INTO users (name,email,password,role) VALUES ($1,$2,$3,$4)', ['Admin','admin@amc.com',bcrypt.hashSync('admin123',10),'admin']);
    ...
    for (const c of clients) {
      await pool.query('INSERT INTO clients (name,phone,email) VALUES ($1,$2,$3)', c);
    }

    const villas = [
      ['Villa 1','A',1],['Villa 3','A',2],['Villa 7','B',3],['Villa 12','B',4],
      ['Villa 15','C',5],['Villa 22','C',6],['Villa 28','D',7],['Villa 35','D',8],
    ];
    for (const v of villas) {
      await pool.query('INSERT INTO villas (villa_number,block,client_id) VALUES ($1,$2,$3)', v);
    }
    ...
    for (const s of schedules) {
      await pool.query(
        'INSERT INTO schedule (villa_id,service_type,technician,scheduled_date,duration_hours) VALUES ($1,$2,$3,$4,$5)', s
      );
    }
    ...
    for (const i of inventory) {
      await pool.query(
        'INSERT INTO inventory (item_name,in_stock,min_level,unit,unit_cost) VALUES ($1,$2,$3,$4,$5)', i
      );
    }
    ...
    for (const o of orders) {
      await pool.query(
        'INSERT INTO procurement_orders (order_number,item_name,quantity,unit,unit_cost,total_cost,supplier,expected_date,status) VALUES ($1,$2,$3,$4,$5,$6,$7,$8,$9)', o
      );
    }
